...
//   const [isFormOpen, setIsFormOpen] = useState(false); // Toggle form visibility like QAPage
...
//       return;
//     }
//     const selectedImages = Array.from(e.target.files).slice(0, 3); // Limit to 3 images
...
//     // Check for token (same authentication method as before)
...
//           ? "You don't have permission to create a post. Please check your login status."
